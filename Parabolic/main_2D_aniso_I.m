...
% In this section Videos are saved in Videos_aniso_I folder
% To check if Videos_aniso_I folder exists otherwise to create
if not(isfolder('Videos_aniso_I'))
    mkdir('Videos_aniso_I')
end
...
videofile = VideoWriter(strcat('Videos_aniso_I/Tumor', video_ext),v_pro);
...
videofile = VideoWriter(strcat('Videos_aniso_I/Acidity', video_ext),v_pro);
videofile.Quality = 100;
videofile.FrameRate = 10;
open(videofile);
...
for i = 1:10:size(M_total,3)
    ...
    xlabel('X' , 'Fontsize', 15);
    ylabel('Y' , 'Fontsize', 15);
    %     saveas(gcf,sprintf('Plots_aniso_I/Tumor_aniso_I_%ddays',3*(i-1)),'epsc');%eps
    saveas(gcf,sprintf('Plots_aniso_I/Tumor_aniso_I_%ddays.png',3*(i-1)));%png
    ...
    xlabel('X' , 'Fontsize', 15);
    ylabel('Y' , 'Fontsize', 15);
    %     saveas(gcf,sprintf('Plots_aniso_I/Acidity_aniso_I_%ddays',3*(i-1)),'epsc');
    saveas(gcf,sprintf('Plots_aniso_I/Acidity_aniso_I_%ddays.png',3*(i-1)))
end
...
xlabel('X' , 'Fontsize', 15);
ylabel('Y' , 'Fontsize', 15);
saveas(gcf,'Plots_aniso_I/FA_aniso_I.png');
%saveas(gcf,'Plots_aniso_I/FA_aniso_I','epsc');
...
xlabel('X' , 'Fontsize', 15);
ylabel('Y' , 'Fontsize', 15);
saveas(gcf,'Plots_aniso_I/Q_macro_aniso_I.png');
% saveas(gcf,'Plots_aniso_I/Q_macro_aniso_I','epsc');
...
xlabel('X' , 'Fontsize', 15);
ylabel('Y' , 'Fontsize', 15);
saveas(gcf,'Plots_aniso_I/q_aniso_I.png');
% saveas(gcf,'Plots_aniso_I/q_aniso_I','epsc');

%% uncomment to save the workspace
if not(isfolder('Mat_files'))
    mkdir('Mat_files')
end
save('Mat_files/main_2D_aniso_I.mat');
%%
toc