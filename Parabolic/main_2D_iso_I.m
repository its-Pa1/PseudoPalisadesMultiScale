...
% In this section Videos are saved in Videos_iso_I folder
% To check if Videos_iso_I folder exists otherwise to create
if not(isfolder('Videos_iso_I'))
    mkdir('Videos_iso_I')
end
...
videofile = VideoWriter(strcat('Videos_iso_I/Tumor', video_ext),v_pro);
...
videofile = VideoWriter(strcat('Videos_iso_I/Acidity', video_ext),v_pro);
videofile.Quality = 100;
videofile.FrameRate = 10;
open(videofile);
...
for i = 1:10:size(M_total,3)
    ...
    xlabel('X' , 'Fontsize', 15);
    ylabel('Y' , 'Fontsize', 15);
    %     saveas(gcf,sprintf('Plots_iso_I/Tumor_iso_I_%ddays',3*(i-1)),'epsc');%eps
    saveas(gcf,sprintf('Plots_iso_I/Tumor_iso_I_%ddays.png',3*(i-1)));%png
    ...
    xlabel('X' , 'Fontsize', 15);
    ylabel('Y' , 'Fontsize', 15);
    %     saveas(gcf,sprintf('Plots_iso_I/Acidity_iso_I_%ddays',3*(i-1)),'epsc');
    saveas(gcf,sprintf('Plots_iso_I/Acidity_iso_I_%ddays.png',3*(i-1)))
end
...
xlabel('X' , 'Fontsize', 15);
ylabel('Y' , 'Fontsize', 15);
saveas(gcf,'Plots_iso_I/FA_iso_I.png');
%saveas(gcf,'Plots_iso_I/FA_iso_I','epsc');
...
xlabel('X' , 'Fontsize', 15);
ylabel('Y' , 'Fontsize', 15);
saveas(gcf,'Plots_iso_I/Q_macro_iso_I.png');
% saveas(gcf,'Plots_iso_I/Q_macro_iso_I','epsc');
...
xlabel('X' , 'Fontsize', 15);
ylabel('Y' , 'Fontsize', 15);
saveas(gcf,'Plots_iso_I/q_iso_I.png');
% saveas(gcf,'Plots_iso_I/q_iso_I','epsc');

%% uncomment to save the workspace
if not(isfolder('Mat_files'))
    mkdir('Mat_files')
end
save('Mat_files/main_2D_iso_I.mat');
%%
toc