...
% In this case the diff. coeff. is given by eq. 2.5.15 of the thesis
...
[D,A] = set_diff_mat_D2(x,dt,DT_scale/(2*Ds_old), x_scale);
...
axis([250 450 0, t(end)]);
saveas(gcf,'Plots_patterns/Tumor_D_alex.png');
...
axis tight
saveas(gcf,'Plots_patterns/Acid_D_alex.png');
...
saveas(gcf,'Plots_patterns/Diff_D_alex.png');
